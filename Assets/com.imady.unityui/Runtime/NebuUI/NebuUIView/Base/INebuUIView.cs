...
{
    /// <summary>
    /// 所有UIView都需要实现的一些通用接口
    /// </summary>
    public interface INebuUIView
    {
        ...
        /// <returns></returns>
        //INebuUIView SetTemplate(GameObject template);

        ///// <summary>
        ///// 设置管理器（View类型对象管理器为LeeUIMananger）
        ///// </summary>
        ///// <param name="manager"></param>
        //INbuUIView SetManager(NbuUIManager manager);
